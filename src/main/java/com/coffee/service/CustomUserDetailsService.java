...
// 해당 클래스는 로그인시 입력한 사용자 정보를 토대로 데이터 베이스에서 읽은 다음 "인증" 인증객체로 반환하는 역할을 합니다.
// 개발자가 직접 호출할 필요는 없고, Spring Security가 임시적으로 호출합니다.
@Service
...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String email) throws UsernameNotFoundException {
        ...
        // Spring Security는 UserDetails의 구현체인 User를 사용하여 사용자 인증(Authentication)과 권한(Authorization)을 수행합니다.
        return User.builder()
